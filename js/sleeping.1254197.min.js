...
function ANGLE(o, t) {
	...
	return n >= 0 && i >= 0 ? e = 2 * Math.PI - e : n >= 0 && i <= 0 && (e = 2 * Math.PI - e), e
}

function cloneObj(o) {
	var t, n = o.constructor === Array ? [] : {};
	if("object" == typeof o) {
		if(window.JSON) t = JSON.stringify(o), n = JSON.parse(t);
		else
			for(var i in o) n[i] = "object" == typeof o[i] ? cloneObj(o[i]) : o[i];
		return n
	}
}
...
function drawDashLine(o, t, n, i, e, a) {
	a = void 0 === a ? 5 : a;
	for(var l = getBeveling(i - t, e - n), h = Math.floor(l / a), p = 0; p < h; p++) o[p % 2 == 0 ? "moveTo" : "lineTo"](t + (i - t) / h * p, n + (e - n) / h * p)
}! function() {
	! function(o) {
		function t() {
			M = window.innerHeight, S = window.innerWidth, o(".sleeping_content,.sleeping_wrap").width(750).height(M), N.width = S, N.height = M, E = new R, N.interactive = !0, N.on("touchend", function() {
				for(var o = 0; o < E.children.length; o++) {
					var t = E.children[o];
					if(new TWEEN.Tween(t.scale).to({
							x: 1,
							y: 1
						}, 100).start(), 0 == t.sex || 1 == t.sex)
						for(var n = 0; n < t.children.length; n++) {
							var i = t.children[n];
							i.children[0] && "bone1" == i.children[0].name ? i.children[0].children[1].dragging = !1 : n == t.children.length - 1 ? i.children[1].dragging = !1 : i.dragging = !1
						} else
							for(var n = 0; n < t.children.length; n++) t.children[0].dragging = !1, t.children[1].children[1].dragging = !1
				}
			}), whiteBg = new X, whiteBg.beginFill(16777215), whiteBg.drawRect(0, 0, 2e3, 2e3), whiteBg.endFill(), J = new R;
			var t = new L(j.resources[T + "room1.jpg"].texture);
			J.index = 0, J.addChild(t), J.interactive = !0, J.buttonMode = !0, J.on("tap", function() {
				if(0 != E.children.length)
					for(var o = 0; o < E.children.length; o++) {
						var t = E.children[o];
						t.chosen = !1, t.outline.visible = !1, O.addChild(t), E.removeChild(t), e(-1)
					}
			}), F = new R;
			var n = new X;
			U ? (n.beginFill(16777215), n.drawRect(0, 0, 750, 249), n.endFill(), F.position.set(0, M - 249), o(".saved_guide").height(249), o(".a_saved_guide").css({
				bottom: "40px"
			}), o(".guide_bg").css({
				top: "177px"
			}), o(".guide img").css({
				top: "0"
			})) : (n.beginFill(16777215), n.drawRect(0, 0, 750, 209), n.endFill(), F.position.set(0, M - 209));
			var i = PIXI.Sprite.fromImage([W[parseInt(Math.random() * W.length)]]);
			i.position.set(575, 30);
			var a = new L(j.resources[T + "erweima_bg.jpg"].texture);
			a.position.set(587, 19);
			var l = new L(j.resources[T + "bottom_logo3.png"].texture),
				h = H[parseInt(Math.random() * H.length)],
				p = new A(h, {
					fontSize: "24px",
					fill: "#000000"
				});
			p.position.set(50, 100), l.position.set(25, 30), F.visible = !1, F.addChild(n, a, i, l, p), D = new R, G = new R, O = new R;
			var s = new X;
			s.beginFill(10053375), s.drawRect(0, 0, 750, 1448), s.endFill(), G.mask = s, G.addChild(s, whiteBg, J, O, E), D.addChild(G, F), N.addChild(D), q.render(N), d()
		}

		function n(o) {
			var t = new R;
			B.push(t), t.chosen = !0, t.interactive = !0, t.buttonMode = !0, t.on("touchstart", function(o) {
				if(new TWEEN.Tween(this.scale).to({
						x: 1.015,
						y: 1.015
					}, 100).start(), !this.chosen) {
					if(this.chosen = !0, this.outline.visible = !0, 0 == E.children.length);
					else {
						var n = E.children[0];
						n.chosen = !1, n.outline.visible = !1, O.addChild(n), E.removeChildren()
					}
					B.remove(this), B.push(this), e(this.sex, t), E.addChild(this), O.removeChild(this)
				}
			...
			var n;
			0 == o ? n = z[0] : 1 == o && (n = Z[0]), t.data = JSON.parse(JSON.stringify(n));
			var a = 50 * Math.random() - 50,
				l = 50 * Math.random() - 50;
			return t.globalPosition = {
				x: t.data.globalPosition.x + a,
				y: t.data.globalPosition.y + l
			}, t.sex = o, t.facingTo = 0, t.faceIndex = 0, t.hairIndex = 0, t.clothIndex = 0, 0 == o ? (_(t, {
				face: uo[t.facingTo][t.faceIndex],
				hair: Po[t.facingTo][t.hairIndex]
			}), g(t, vo[0][0]), setTimeout(function() {
				m(t)
			}, 100)) : 1 == o && (_(t, {
				face: Co[t.facingTo][t.faceIndex],
				hair: Io[t.facingTo][t.hairIndex]
			}), g(t, ko[0][0]), setTimeout(function() {
				m(t)
			}, 100)), i(o, t), t
		}
		...
		function a(o, t) {
			o.facingTo != t && (o.facingTo = t, 0 == o.sex ? (o.removeChildren(), o.data = JSON.parse(JSON.stringify(z[t])), _(o, {
				face: uo[t][o.faceIndex],
				hair: Po[t][o.hairIndex]
			}), g(o, vo[t][o.clothIndex]), setTimeout(function() {
				m(o)
			}, 100)) : 1 == o.sex && (o.removeChildren(), o.data = JSON.parse(JSON.stringify(Z[t])), _(o, {
				face: Co[t][o.faceIndex],
				hair: Io[t][o.hairIndex]
			}), g(o, ko[t][o.clothIndex]), setTimeout(function() {
				m(o)
			}, 100)))
		}

		function l(t) {
			t && (t.clothIndex && t.clothIndex > 2 ? o(".cloth").animate({
				scrollLeft: 130 * (t.clothIndex - 2) + "px"
			}, 300) : o(".cloth").animate({
				scrollLeft: "0px"
			}, 300), t.facingTo && t.facingTo > 2 ? o(".facingTo").animate({
				scrollLeft: 130 * (t.facingTo - 2) + "px"
			}, 300) : o(".facingTo").animate({
				scrollLeft: "0px"
			}, 300), t.faceIndex && t.faceIndex > 2 ? o(".face").animate({
				scrollLeft: 130 * (t.faceIndex - 2) + "px"
			}, 300) : o(".face").animate({
				scrollLeft: "0px"
			}, 300), t.hairIndex && t.hairIndex > 2 ? o(".hair").animate({
				scrollLeft: 130 * (t.hairIndex - 2) + "px"
			}, 300) : o(".hair").animate({
				scrollLeft: "0px"
			}, 300))
		}
		...
		function h(o, t) {
			if(o.face && o.faceIndex != t) {
				if(o.faceIndex = t, 0 == o.sex) {
					o.head.removeChildAt(1);
					var n = PIXI.Sprite.fromImage(uo[o.facingTo][t].url);
					n.position.set(uo[o.facingTo][t].position.x, uo[o.facingTo][t].position.y), o.head.addChildAt(n, 1), o.face = n
				}
				if(1 == o.sex) {
					o.head.removeChildAt(1);
					var n = PIXI.Sprite.fromImage(Co[o.facingTo][t].url);
		...
		function p(o, t) {
			if(o.hairIndex != t) {
				o.hairIndex = t;
				var n = o.hair.visible;
				if(0 == o.sex) {
					o.head.removeChildAt(o.head.children.length - 1);
					var i = PIXI.Sprite.fromImage(Po[o.facingTo][t].url);
					i.position.set(Po[o.facingTo][t].position.x, Po[o.facingTo][t].position.y), o.head.addChild(i), o.hair = i
				}
				if(1 == o.sex) {
					o.head.removeChildAt(o.head.children.length - 1);
					var i = PIXI.Sprite.fromImage(Io[o.facingTo][t].url);
		...
		function s(o) {
			if(J.index != o) {
				J.removeChildren(), J.index = o;
				var t = PIXI.Sprite.fromImage([Uo[o]]);
				J.addChild(t)
			}
		}

		function r(o) {
			if(e(-1), 1 == E.children.length) {
				var t = E.children[0];
				t.chosen = !1, t.outline.visible = !1, O.addChild(t), E.removeChildren()
			}
			var n = new R;
			n.chosen = !0, n.interactive = !0, n.buttonMode = !0, n.on("touchstart", function(o) {
				if(new TWEEN.Tween(this.scale).to({
						x: 1.015,
						y: 1.015
					}, 100).start(), !this.chosen) {
					...
					e(-1), E.addChild(this), O.removeChild(this)
				}
			}), n.data = {};
			var i = 50 * Math.random() - 50,
				a = 50 * Math.random() - 50;
			n.globalPosition = {
				x: 200 + i,
				y: 500 + a
			}, n.position.set(n.globalPosition.x, n.globalPosition.y);
			var l = PIXI.Sprite.fromImage(To[o - 1]);
			l.interactive = !0, l.buttonMode = !0;
			var h = new R;
			n.addChild(l, h), n.outline = h, l.texture.baseTexture.hasLoaded ? b(n) : l.texture.baseTexture.on("loaded", function() {
				b(n)
			}), E.addChild(n)
		}
		...
		function g(o, t) {
			...
			if(i.position.set(t.clothPosition.x, t.clothPosition.y), t.hatUrl) {
				o.hair.visible = !1;
				var e = PIXI.Sprite.fromImage(t.hatUrl);
				e.position.set(t.hatPosition.x, t.hatPosition.y), o.head.addChildAt(e, 2)
			}
			for(var a = (o.boneData, 0); a < 4; a++) {
				var l = o.boneData[a];
				if(t.part[a][0]) {
					var h = PIXI.Sprite.fromImage(t.part[a][0]);
					h.interactive = !0, h.buttonMode = !0, h.on("touchstart", function(o) {
						y.call(this.parent.children[1], o)
					}).on("touchmove", function(o) {
						x.call(this.parent.children[1], o)
					}), h.position.set(t.bones[a].bone1.position.x, t.bones[a].bone1.position.y), h.name = "addEdCloth", l.children[0].addChild(h)
				}
				if(t.part[a][1]) {
		...
		function c(o) {
			if(!(o.body.children.length < 2)) {
				o.hair.visible = !0, 4 == o.head.children.length ? o.head.removeChildAt(2) : 3 == o.facingTo && 3 == o.head.children.length && o.head.removeChildAt(2);
				var t = o.body;
		...
		function _(o, t) {
			...
			l.position.set(o.data.bodyImgPosition.x, o.data.bodyImgPosition.y);
			var h = new R;
			h.position.set(o.data.bodyPosition.x + o.data.headPosition.x, o.data.bodyPosition.y + o.data.headPosition.y);
			var p = PIXI.Sprite.fromImage(o.data.headUrl);
			if(h.addChild(p), t.face) {
				var s = PIXI.Sprite.fromImage(t.face.url);
				s.position.set(t.face.position.x, t.face.position.y), h.addChild(s), o.face = s
			} else o.face = null;
			var r = PIXI.Sprite.fromImage(t.hair.url);
			o.hair = r, r.position.set(t.hair.position.x, t.hair.position.y), h.addChild(r), a.interactive = !0, a.buttonMode = !0, a.on("touchstart", function(o) {
				this.dragging = !0, this.startPosition = {
					x: o.data.global.x,
					y: o.data.global.y
				}
			}).on("touchmove", function(o) {
				...
				this.dragging = !1, this.parent.globalPosition.x = this.parent.position.x - this.parent.pivot._x, this.parent.globalPosition.y = this.parent.position.y - this.parent.pivot._y
			}), a.position.set(o.data.bodyPosition.x, o.data.bodyPosition.y), a.addChild(l), o.head = h, o.body = a;
			var g = new R;
			g.name = "hand";
			var c = new R;
			c.name = "hand";
			...
			for(var f = 0; f < i.length; f++) {
				var w = d[f],
					...
					u = v.bone1,
					P = v.bone2;
				w.position.set(u.position.x + u.pivot.x, u.position.y + u.pivot.y), w.pivot.set(u.pivot.x, u.pivot.y), n[f].boneRotate && (w.rotation = n[f].boneRotate);
				var k = new R;
				k.name = "bone1", k.position.set(u.pivot.x, u.pivot.y), k.pivot.set(u.pivot.x, u.pivot.y), k.rotation = n[f].bone1.rotation;
				var C = PIXI.Sprite.fromImage(o.data.part[f][0]);
				k.addChild(C), C.interactive = !0, C.buttonMode = !0, C.on("touchstart", function(o) {
					y.call(this.parent.children[1], o)
				}).on("touchmove", function(o) {
					x.call(this.parent.children[1], o)
				});
				var I = new X;
				I.beginFill(65535), I.drawCircle(0, 0, 2), I.endFill(), I.position.set(u.position.x + u.pivot.x, u.position.y + u.pivot.y);
				var U = new X;
				U.beginFill(65535), U.drawCircle(0, 0, 2), U.endFill(), U.position.set(P.position.x + P.pivot.x, P.position.y + P.pivot.y), I.visible = !1, U.visible = !1, b.addChild(I);
				var T = new R;
				T.name = "bone2";
				var S = PIXI.Sprite.fromImage(o.data.part[f][1]),
					M = new X;
			...
			0 == e ? o.addChild(_, m, a, g, c, b, h) : 3 == e ? o.addChild(_, m, g, c, a, b, h) : 2 == e ? o.addChild(g, _, m, a, c, b, h) : 1 == e && o.addChild(c, _, m, a, g, b, h);
			var j = new R;
		...
		function y(o) {
			this.dragging = !0, this.data.rotation = this.parent.parent.rotation;
			var t = o.data.global;
			this.startPosition = {
				x: t.x,
				y: t.y
			...
			this.startRotation = n, this.dragSrartPosition = {
				x: this.children[1].getGlobalPosition().x,
				y: this.children[1].getGlobalPosition().y
			}, this.a = DISTANCE(this.dragSrartPosition, this.getGlobalPosition()), this.b = DISTANCE(this.getGlobalPosition(), this.parent.getGlobalPosition())
		}
		...
		function m(o) {
			o.outline.removeChildren();
			var t = new X;
			t.lineStyle(1, 16777215, 1);
			var n = o.width,
				i = o.height;
			3 != o.facingTo && 6 == o.faceIndex && (i -= 130), t.moveTo(0, 0), drawDashLine(t, 0, 0, n, 0), drawDashLine(t, n, 0, n, i), drawDashLine(t, n, i, 0, i), drawDashLine(t, 0, i, 0, 0), o.outline.addChild(t);
			var a = new L(j.resources[T + "rotate.png"].texture);
			a.position.set(-43, -38), a.interactive = !0, a.buttonMode = !0, a.on("touchstart", function(o) {
				this.dragging = !0;
				var t = o.data.global;
			...
			var l = new L(j.resources[T + "close.png"].texture);
			l.position.set(n, -38), l.interactive = !0, l.buttonMode = !0, l.on("tap", function() {
				B.remove(this.parent.parent), this.parent.parent.parent.removeChild(this.parent.parent), B.length > 0 ? e(B[B.length - 1].sex, B[B.length - 1]) : e(-100)
			}), o.outline.addChild(a, l)
		}
		...
		function b(o) {
			...
			var n = o.width,
				i = o.height;
			o.pivot.set(n / 2, i / 2), o.position.set(o.globalPosition.x + n / 2, o.globalPosition.y + i / 2);
			var a = 20;
			t.moveTo(-a, -a), drawDashLine(t, -a, -a, n + a, -a), drawDashLine(t, n + a, -a, n + a, i + a), drawDashLine(t, n + a, i + a, -a, i + a), drawDashLine(t, -a, i + a, -a, -a), o.children[0].on("touchstart", function(o) {
				this.dragging = !0, this.startPosition = {
					x: o.data.global.x,
					y: o.data.global.y
				}
				...
				this.dragging = !1, this.parent.globalPosition.x = this.parent.position.x - this.parent.pivot._x, this.parent.globalPosition.y = this.parent.position.y - this.parent.pivot._y
			}), o.outline.addChild(t);
			var l = new L(j.resources[T + "rotate.png"].texture);
			l.position.set(-a - 43, -a - 38), l.interactive = !0, l.buttonMode = !0, l.on("touchstart", function(o) {
				this.dragging = !0;
				var t = o.data.global;
				this.parent.parent.data.rotation = this.parent.parent.rotation;
				var n = ANGLE({
			...
			var h = new L(j.resources[T + "close.png"].texture);
			h.position.set(n + a, -a - 38), h.interactive = !0, h.buttonMode = !0, h.on("tap", function() {
				this.parent.parent.parent.removeChild(this.parent.parent), e(-1)
			}), o.outline.addChild(l, h)
		}

		function d() {
			TWEEN.update(), requestAnimationFrame(d), q.render(N)
		}

		function f(o) {
			var t = o.index();
			t > 2 ? o.parent().parent().animate({
				scrollLeft: 130 * (t - 2) + "px"
			}, 300) : o.parent().parent().animate({
				scrollLeft: "0px"
			}, 300)
		}
		...
		if(!P) {
			...
			return o(".sleeping_wrap").height(M), o(".sleeping_wrap").html(""), void o(".sleeping_wrap").css({
		...
		k || h5Share.init({
			title: "360\xb0\u82b1\u5f0f\u7761\u89c9\uff01\u5feb\u6765\u6446\u4e00\u4e2a\u8ff7\u4e4b\u7761\u59ff",
			desc: "\u5728\u8fd9\u91cc\uff0c\u7761\u89c9\u771f\u7684\u80fd\u4e3a\u6240\u6b32\u4e3a\uff01",
			url: window.location.href,
			img: "img/banners.jpeg"
		}), o(".first_page,.guide").bind("touchmove", function(o) {
			o.preventDefault()
		});
		var M = window.innerHeight,
			...
			A = (PIXI.loader.resources, PIXI.utils.TextureCache, PIXI.Texture, PIXI.Text),
			L = (new PIXI.ticker.Ticker, PIXI.Sprite),
			X = (PIXI.Rectangle, PIXI.Graphics),
			N = new R;
		N.width = S, N.height = M;
		var q = new PIXI.CanvasRenderer(S, M, {
			backgroundColor: 16777215
		});
		o("#content").append(q.view), j.add(T + "rotate.png").add(T + "close.png").add(T + "room1.jpg").add(T + "erweima_bg.jpg").add(T + "bottom_logo3.png").add(T + "man_left/body.png").add(T + "man_right/body.png").add(T + "woman_left/body.png").add(T + "woman_right/body.png").load(t);
		for(var E, O, D, G, F, J, B = [], 
		W = [T + "erweima/erweima00.jpg", T + "erweima/erweima01.jpg"],
		H = [
				"以下是unicode编码，可用unscape函数转码查看原文，此处注销即可用"
//				"\u522b\u8ddf\u6211\u8c08\u7761\u89c9\u8fd9\u4ef6\u4e8b\uff0c\u6212\u4e86", 
//				"\u7761\u7720\u662f\u4e00\u79cd\u827a\u672f",
//				"\u4e00\u89c9\u6cbb\u767e\u75c5\uff0c\u4e00\u89c9\u5e73\u5929\u4e0b",
//				"\u65e0\u8bba\u7761\u5728\u54ea\u91cc\uff0c\u6211\u90fd\u7761\u5728\u7f8e\u68a6\u91cc",
...
//				"\u5df4\u5566\u5566\u80fd\u91cf\u2014\u547c\u5566\u5566\u2014\u7761\uff01"
		...
		z = [{
				...
				part: [
					[T + "man/cloth2/left_arm.png", T + "man/cloth2/left_hand.png"],
					[T + "man/cloth2/right_arm.png", T + "man/cloth2/right_hand.png"],
					[T + "man/cloth2/left_leg.png", T + "man/cloth2/left_foot.png"],
					[T + "man/cloth2/right_leg.png", T + "man/cloth2/right_foot.png"]
				],
				bones: [{
					bone1: {
						position: {
				...
				clothUrl: T + "man/cloth4/body.png",
				clothPosition: {
					x: -7,
					y: 88
				},
				part: [
					[T + "man/cloth4/left_arm.png", 0],
					[T + "man/cloth4/right_arm.png", 0],
					[T + "man/cloth4/left_leg.png", 0],
					[T + "man/cloth4/right_leg.png", 0]
				],
				bones: [{
					bone1: {
						position: {
				...
				part: [
					[T + "man/cloth5/left_arm.png", T + "man/cloth5/left_hand.png"],
					[T + "man/cloth5/right_arm.png", T + "man/cloth5/right_hand.png"],
					[T + "man/cloth5/left_leg.png", T + "man/cloth5/left_foot.png"],
					[T + "man/cloth5/right_leg.png", T + "man/cloth5/right_foot.png"]
				],
				bones: [{
					bone1: {
						position: {
				...
				part: [
					[T + "man/cloth7/left_arm.png", T + "man/cloth7/left_hand.png"],
					[T + "man/cloth7/right_arm.png", T + "man/cloth7/right_hand.png"],
					[T + "man/cloth7/left_leg.png", T + "man/cloth7/left_foot.png"],
					[T + "man/cloth7/right_leg.png", T + "man/cloth7/right_foot.png"]
				],
				bones: [{
					bone1: {
						position: {
				...
				clothUrl: T + "man/cloth8/body.png",
				clothPosition: {
					x: -8,
					y: 85
				},
				part: [
					[T + "man/cloth8/left_arm.png", 0],
					[T + "man/cloth8/right_arm.png", 0],
					[T + "man/cloth8/left_leg.png", 0],
					[T + "man/cloth8/right_leg.png", 0]
				],
				bones: [{
					bone1: {
						position: {
				...
				clothUrl: T + "man/cloth9/body.png",
				clothPosition: {
					x: -9,
					y: 85
				},
				part: [
					[T + "man/cloth9/left_arm.png", T + "man/cloth9/left_hand.png"],
					[T + "man/cloth9/right_arm.png", T + "man/cloth9/right_hand.png"],
					[T + "man/cloth9/left_leg.png", T + "man/cloth9/left_foot.png"],
					[T + "man/cloth9/right_leg.png", T + "man/cloth9/right_foot.png"]
				],
				bones: [{
					bone1: {
						position: {
				...
				hatUrl: T + "man_back/cloth1/hat.png",
				hatPosition: {
					x: -25,
					y: -24
				},
				...
				clothUrl: T + "man_back/cloth4/body.png",
				clothPosition: {
					x: -7,
					y: 86
				},
				...
				clothUrl: T + "man_back/cloth8/body.png",
				clothPosition: {
					x: -9,
					y: 84
				},
				...
				clothUrl: T + "man_back/cloth9/body.png",
				clothPosition: {
					x: -9,
					y: 84
				},
				...
				clothUrl: T + "man_right/cloth.png",
				clothPosition: {
					x: 0,
					y: 91
				},
				...
				hatUrl: T + "man_right/cloth1/hat.png",
				hatPosition: {
					x: -26,
					y: -33
				},
				...
				clothUrl: T + "man_right/cloth4/body.png",
				clothPosition: {
					x: -2,
					y: 88
				},
				...
				clothUrl: T + "man_right/cloth8/body.png",
				clothPosition: {
					x: -5,
					y: 89
				},
				...
				clothUrl: T + "man_right/cloth9/body.png",
				clothPosition: {
					x: -4,
					y: 89
				},
				...
				hatUrl: T + "man_left/cloth1/hat.png",
				hatPosition: {
					x: -5,
					y: -33
				},
				...
				clothUrl: T + "man_left/cloth4/body.png",
				clothPosition: {
					x: -3,
					y: 88
				},
				...
				clothUrl: T + "man_left/cloth8/body.png",
				clothPosition: {
					x: -2,
					y: 89
				},
				...
				clothUrl: T + "man_left/cloth9/body.png",
				clothPosition: {
					x: -3,
					y: 89
				},
				...
				hatUrl: T + "woman/cloth4/hat.png",
				hatPosition: {
					x: -20,
					y: -24
				},
				clothUrl: T + "woman/cloth4/body.png",
				clothPosition: {
					x: -14,
					y: 93
				},
				...
				clothUrl: T + "woman/cloth8/body.png",
				clothPosition: {
					x: -5,
					y: 87
				},
				...
				clothUrl: T + "woman/cloth9/body.png",
				clothPosition: {
					x: -3,
					y: 91
				},
				...
				clothUrl: T + "woman_back/cloth.png",
				clothPosition: {
					x: 11,
					y: 92
				},
				...
				hatUrl: T + "woman_back/cloth1/hat.png",
				hatPosition: {
					x: -20,
					y: -10
				},
				...
				hatUrl: T + "woman_back/cloth4/hat.png",
				hatPosition: {
					x: -20,
					y: -24
				},
				clothUrl: T + "woman_back/cloth4/body.png",
				clothPosition: {
					x: -14,
					y: 94
				},
				...
				clothUrl: T + "woman_back/cloth8/body.png",
				clothPosition: {
					x: -5,
					y: 89
				},
				...
				clothUrl: T + "woman_back/cloth9/body.png",
				clothPosition: {
					x: -1,
					y: 93
				},
				...
				clothUrl: T + "woman_right/cloth.png",
				clothPosition: {
					x: 0,
					y: 90
				},
				...
				hatUrl: T + "woman_right/cloth1/hat.png",
				hatPosition: {
					x: -13,
					y: -15
				},
				...
				hatUrl: T + "woman_right/cloth4/hat.png",
				hatPosition: {
					x: -10,
					y: -16
				},
				...
				clothUrl: T + "woman_right/cloth8/body.png",
				clothPosition: {
					x: 8,
					y: 89
				},
				...
				clothUrl: T + "woman_right/cloth9/body.png",
				clothPosition: {
					x: 8,
					y: 93
				},
				...
				clothUrl: T + "woman_left/cloth.png",
				clothPosition: {
					x: 28,
					y: 90
				},
				...
				hatUrl: T + "woman_left/cloth1/hat.png",
				hatPosition: {
					x: -8,
					y: -15
				},
				...
				hatUrl: T + "woman_left/cloth4/hat.png",
				hatPosition: {
					x: -9,
					y: -16
				},
				...
				clothUrl: T + "woman_left/cloth8/body.png",
				clothPosition: {
					x: -4,
					y: 89
				},
				...
				clothUrl: T + "woman_left/cloth9/body.png",
				clothPosition: {
					x: -3,
					y: 93
				},
			...
			}], eo = 0; eo < 7; eo++) io[eo].url = T + "man/face" + (eo + 1) + ".png";
		for(var ao = [{
				position: {
					x: 2,
					y: -7
			...
			}], eo = 0; eo < 14; eo++) ao[eo].url = T + "man/hair" + (eo + 1) + ".png";
		for(var lo = [], ho = [{
				position: {
					x: 2,
					y: -8
			...
			}], eo = 0; eo < 14; eo++) ho[eo].url = T + "man_back/hair" + (eo + 1) + ".png", lo.push(!1);
		for(var po = [{
				position: {
					x: 38,
					y: 41
			...
			}], eo = 0; eo < 7; eo++) po[eo].url = T + "man_right/face" + (eo + 1) + ".png";
		for(var so = [{
				position: {
					x: -1,
					y: -3
			...
			}], eo = 0; eo < 14; eo++) so[eo].url = T + "man_right/hair" + (eo + 1) + ".png";
		for(var ro = [{
				position: {
					x: 12,
					y: 41
			...
			}], eo = 0; eo < 7; eo++) ro[eo].url = T + "man_left/face" + (eo + 1) + ".png";
		for(var go = [{
				position: {
					x: 10,
					y: -3
			...
			}], eo = 0; eo < 14; eo++) go[eo].url = T + "man_left/hair" + (eo + 1) + ".png";
		for(var co = [{
				position: {
					x: 13,
					y: 36
			...
			}], eo = 0; eo < 7; eo++) co[eo].url = T + "man/face" + (eo + 1) + ".png";
		for(var _o = [{
				position: {
					x: -12,
					y: -8
			...
			}], eo = 0; eo < 14; eo++) _o[eo].url = T + "woman/hair" + (eo + 1) + ".png";
		for(var yo = [], xo = [{
				position: {
					x: -10,
					y: -8
			...
			}], eo = 0; eo < 14; eo++) xo[eo].url = T + "woman_back/hair" + (eo + 1) + ".png", yo.push(!1);
		for(var mo = [{
				position: {
					x: 48,
					y: 38
			...
			}], eo = 0; eo < 7; eo++) mo[eo].url = T + "woman_right/face" + (eo + 1) + ".png";
		for(var bo = [{
				position: {
					x: -8,
					y: -8
			...
			}], eo = 0; eo < 14; eo++) bo[eo].url = T + "woman_right/hair" + (eo + 1) + ".png";
		for(var fo = [{
				position: {
					x: 5,
					y: 41
			...
			}], eo = 0; eo < 7; eo++) fo[eo].url = T + "woman_left/face" + (eo + 1) + ".png";
		for(var wo = [{
				position: {
					x: 3,
					y: -8
			...
			}], eo = 0; eo < 14; eo++) wo[eo].url = T + "woman_left/hair" + (eo + 1) + ".png";
		var vo = [Q, Y, V, K],
			uo = [io, ro, po, lo],
			Po = [ao, go, so, ho],
			ko = [$, no, to, oo],
			...
			Io = [_o, wo, bo, xo];
		i(-1);
		var Uo = [T + "room1.jpg", T + "room2.jpg", T + "room3.jpg", T + "room4.jpg", T + "room5.jpg"],
			To = [T + "others/0-0.png", T + "others/0-1.png", T + "others/0-2.png", T + "others/1-0.png", T + "others/1-1.png", T + "others/1-4.png", T + "others/1-3.png", T + "others/2-0.png", T + "others/2-1.png", T + "others/2-2.png", T + "others/2-3.png", T + "others/3-0.png", T + "others/3-1.png", T + "others/3-2.png", T + "others/3-3.png", T + "others/3-4.png", T + "others/3-5.png", T + "others/3-6.png", T + "others/3-7.png", T + "others/4-0.png", T + "others/4-1.png", T + "others/4-2.png", T + "others/5-0.png", T + "others/6-0.png", T + "others/6-1.png", T + "others/6-2.png", T + "others/6-3.png", T + "others/6-4.png"],
			So = 0;
		o(".scroll_bar ul li").bind("click", function() {
			if(!o(this).hasClass("selected")) {
				o(".select_main").hasClass("close") && o(".select_main").removeClass("close"), o(".selected").removeClass("selected"), o(this).addClass("selected");
				var t = o(this).index();
				So = t;
				var n = B[B.length - 1];
				n && (t > 0 && t < 5 && (n.currentSelectIndex = t), l(n)), o(".select_item").hide(), o(".select_item").eq(t).show(), o(".black_icon").css({
					left: 103 * t
				}), t > 3 ? o(".scroll_bar").animate({
					scrollLeft: "54px"
				}, 300) : o(".scroll_bar").animate({
					scrollLeft: "0px"
				}, 300)
			}
		}), o(".arrow_bg").bind("click", function() {
			o(".select_main").hasClass("close") ? (o(".select_main").removeClass("close"), o(".black_icon").show()) : (o(".select_main").addClass("close"), o(".black_icon").hide())
		}), o(".select_people li").bind("click", function() {
			var t = o(this).index();
			if(o(".select_guide").hide(), o(".save").show(), o(".select_people li").removeClass("active"), o(this).addClass("active"), 0 == E.children.length) {
				var i = n(t);
				E.addChild(i)
			} else if(1 == E.children.length) {
				var e = E.children[0];
				O.addChild(e), e.chosen = !1, e.outline.visible = !1, E.removeChildren();
				var i = n(t);
				E.addChild(i)
			}
			setTimeout(function() {
				o(".select_people li").eq(t).removeClass("active")
			}, 300)
		}), o(".man_facingTo li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			o(".man_facingTo li").removeClass("active"), o(this).addClass("active"), a(t, n)
		}), o(".woman_facingTo li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			o(".woman_facingTo li").removeClass("active"), o(this).addClass("active"), a(t, n)
		}), o(".man_cloth li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			t.clothIndex = n, o(".man_cloth li").removeClass("active"), o(this).addClass("active"), c(t), g(t, vo[t.facingTo][n]), f(o(this))
		}), o(".woman_cloth li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			t.clothIndex = n, o(".woman_cloth li").removeClass("active"), o(this).addClass("active"), c(t), g(t, ko[t.facingTo][n]), f(o(this))
		}), o(".man_face li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			o(".man_face li").removeClass("active"), o(this).addClass("active"), h(t, n), f(o(this))
		}), o(".man_hair li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			o(".man_hair li").removeClass("active"), o(this).addClass("active"), p(t, n), f(o(this))
		}), o(".woman_hair li").bind("click", function() {
			var t = B[B.length - 1];
			w(t);
			var n = o(this).index();
			o(".woman_hair li").removeClass("active"), o(this).addClass("active"), p(t, n), f(o(this))
		}), o(".room li").bind("click", function() {
			o(".save").show();
			var t = o(this).index();
			o(".room li").removeClass("active"), o(this).addClass("active"), s(t)
		}), o(".others li").bind("click", function() {
			o(".save").show();
			var t = o(this).index();
			o(".others li").removeClass("active"), o(this).addClass("active"), r(t + 1), setTimeout(function() {
				o(".others li").eq(t).removeClass("active")
			}, 300), f(o(this))
		}), o(".start").bind("click", function() {
			o(".first_page").fadeOut(300), o(".sleeping_content").show()
		}), o(".guide").bind("click", function() {
			o(".guide").fadeOut(300)
		}), U && o(".select").addClass("iphoneX"), o(".save").bind("click", function() {
			if(o(".select").hide(), new TWEEN.Tween(G.scale).to({
					x: .933,
					y: .933
				}, 200).onUpdate(function() {
					G.position.set((1 - this.x) / .067 * 25, (1 - this.x) / .067 * 25)
				}).start(), 0 != E.children.length)
				for(var t = 0; t < E.children.length; t++) {
					var n = E.children[t];
					n.chosen = !1, n.outline.visible = !1, O.addChild(n), E.removeChild(n), e(-1)
				}
			F.visible = !0, setTimeout(function() {
				setTimeout(function() {
					var t = convertCanvasToImage(o("canvas")[0]);
					o(".result_img").append(t), o(".result_img").show(), o(".saved_img").append(t), o(".saved_img").show(), setTimeout(function() {
						I && C ? o(".a_saved_guide").fadeIn(300) : o(".saved_guide").fadeIn(300), setTimeout(function() {
							I && C ? o(".a_saved_guide").fadeOut(300) : o(".saved_guide").fadeOut(300)
						}, 3e3)
					}, 500)
				}, 30)
			}, 200)
